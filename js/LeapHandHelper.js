(function() {
  ...
  var getMatrixFromArray = function(arr) {
    ...
    matrix.set(arr[0], arr[1], arr[2], 0, arr[4], arr[5], arr[6], 0, arr[8], arr[9], arr[10], 0, 0, 0, 0, 0);
    return matrix;
  };

  var ROTATION_OFFSET = new THREE.Quaternion().setFromAxisAngle(new THREE.Vector3(0, 0, 1), -Math.PI / 2);
